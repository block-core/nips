...
See [BCIP-0006](https://github.com/block-core/bcips/blob/main/bcip-0006.md) for full message format specifications.

## Additional

The full P2P Funding Protocol can be found at [BCIP-0005](https://github.com/block-core/bcips/blob/main/bcip-0005.md).

The full Nostr communication protocol specification can be found at [BCIP-0006](https://github.com/block-core/bcips/blob/main/bcip-0006.md).
